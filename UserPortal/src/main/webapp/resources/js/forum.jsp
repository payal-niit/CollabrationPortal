	...
	<div class="addform container" ng-controller="ForumController as forumCtrl">
		...
		<form role="form" name="forumForm" method="POST" enctype="multipart/form-data">
			...
			<div class="row">
				<div class="col-md-6 col-sm-6 col-xs-6">
					<input type="text" class="form-control"
						...
						ng-model="forumCtrl.forum.forumTitle" name="forumTitle" required />
				</div>
				<div class="col-md-6 col-sm-6 col-xs-6">
					<input type="text" class="form-control"
						placeholder="Forum Description"
						ng-model="forumCtrl.forum.forumDescription" name="forumDescription" required />
				</div>
			...
			<!-- <div class="row">
			 ...
			 <div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
				<input type="file" class="form-control" name="forumImage" ng-model="forumCtrl.forum.forumImage" file-model="myFile">
				</div>
			</div> 
